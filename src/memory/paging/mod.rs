...
pub struct ActivatePageTable {
    p4: Unique<Table<Level4>>,
}

impl ActivatePageTable {
    pub unsafe fn new() -> ActivatePageTable {
        ActivatePageTable {
    ...
    fn translate_page(&self, page: Page) -> Option<Frame> {
        ...
        let huge_page = || {  // This was just straight copied.  I need to understand this
            p3.and_then(|p3| {
...
pub fn test_paging<A>(allocator: &mut A) where A: FrameAllocator {
    ...
    let mut page_table = unsafe { ActivatePageTable::new() };
